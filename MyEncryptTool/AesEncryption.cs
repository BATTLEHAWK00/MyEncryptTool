...
namespace WindowsFormsApp3
{
        ...
        private Dictionary<string, CipherMode> modes = new Dictionary<string, CipherMode>()
    {
        ...
        public string EncryptFile(string path, string targetpath, string password = null)
        {
        ...
        public string DecryptFile(string path, string targetpath, string password = null)
        {
            byte[] salt = new byte[saltLen];
            byte[] iv = new byte[ivLen];
            byte[] mac = new byte[macLen];
            try
            {
                ...
                string newPath = Regex.Replace(targetpath, ".enc$", "");
